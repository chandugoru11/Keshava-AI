...
const PortalRedirect: React.FC = () => {
  ...
  // Explicitly check role for redirect
  switch(user.role) {
    case UserRole.ADMIN:
    ...
    case UserRole.HR:
      return <Navigate to="/portal/hr" replace />;
    case UserRole.TRAINER:
      return <Navigate to="/portal/trainer" replace />;
    default:
...
const Unauthorized: React.FC = () => (
  <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-4">
    <div className="bg-white p-10 rounded-3xl shadow-xl border border-gray-100 flex flex-col items-center max-w-md">
      ...
      <p className="text-gray-500 text-center mb-8">You don't have permission to view this section.</p>
      <button 
